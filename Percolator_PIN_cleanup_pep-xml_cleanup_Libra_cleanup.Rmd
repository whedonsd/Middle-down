...
---
This is for preparing pep.xml and PIN files for work in the Trans Proteomic Pipeline.
A number of these steps have been incorporated in Disambiguator.Rmd. However, this will allow complete processing of the pep.xml for viewing in the TPP Petunia interface.
